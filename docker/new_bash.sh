...
function pull_or_clone_proj() {
 ...
 #  git branch -f master origin/master
   ...
   cd ..
    ...
    git clone --branch home_task_4 ${SERVICE_URL} ${SERVICE_NAME}
 fi
}
...
pull_or_clone_proj common-module https://github.com/Artem895/common-module.git
pull_or_clone_proj medical-monitoring https://github.com/Artem895/medical-monitoring.git
pull_or_clone_proj message-analyzer https://github.com/Artem895/message-analyzer.git
pull_or_clone_proj person-service https://github.com/Artem895/person-service.git
